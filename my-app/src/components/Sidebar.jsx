    ...
    <SideBar
        ...
        <div className="h-full w-full p-3 bg-[#3a3939]">
          <ul className='nav-list flex flex-col'>
            ...
            <a onClick={()=>setSidebarOpen(prev=>!prev)} href='#Skills' className='cursor-pointer px-3 py-5 hover:bg-gray-900 rounded-md text-xl'>Skills</a>
            <a onClick={()=>setSidebarOpen(prev=>!prev)} href='#Work' className='cursor-pointer px-3 py-5 hover:bg-gray-900 rounded-md text-xl'>Work</a>
